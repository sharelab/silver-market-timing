...
Using the regression results from the previous part, we can try to construct a silver fair value indicator. According to the linear regression model above, 
